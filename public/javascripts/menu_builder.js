// Add preferences to menu builder form
...
function addPrice() {
  ...
  var symbolText = priceSymbols[priceSymbol];
...
// Applies all previously entered values/selections to form
...
// Applies previously entered value/selection to form
